---
title: "情绪识别"
description: "Alexandrine Fortier 等人的 [Backdoor Attacks Against Speech Language Models](http://arxiv.org/abs/2510.01157v1 ) 首次系统研究了**语音语言模型的后门攻击**。实验覆盖四种语音编码器和三个数据集（涉及语音识别、情感识别等任务），攻击成功率高达90.76%-99.41%。**关键发现**包括：级联式多模态模型会继承所有组件的漏洞，且预训练编码器是最脆弱环节。作者还提出了一种基于微调的防御方法，可缓解中毒编码器的威胁。"
date: 2025-12-30
lang: zh
slug: "情绪识别"
tags: []
