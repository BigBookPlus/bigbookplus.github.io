---
title: "2021-08-26-operator-and-in-opencv"
description: "假设需要按照既定的ROI对图像进行取窗裁剪，用`cv::Rect`给定ROI区域，裁剪可以按照如下方式："
date: 2021-08-26
lang: zh
slug: "operator-and-in-opencv"
tags: ["C-Cpp", "Operator &", "OpenCV", "Image Processing", "边界检查"]
featured: false
draft: false
---
